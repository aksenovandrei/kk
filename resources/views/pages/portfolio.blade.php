        ...
        <div class="content-wrapper clearfix">
            <div class="col-sm-11 pull-right">
                            ...
                            <div class="slider">
                                <div class="slider-item">
                                    <a href="http://truemanbox.ru/" target="_blank">
                                        <img class="lazyOwl" src="{{asset('img/trueman-preview.jpg')}}">
                                    </a>
                            ...
                            <div class="slider">
                                <div class="slider-item">
                                    <a href="https://valery.fm/antichaos4" target="_blank">
                                        <img class="lazyOwl" src="{{asset('img/morozovlead-preview.jpg')}}">
                                    </a>
                                ...
                                <div class="slider-item">
                                    <a href="http://www.kosmetologiya-kazan.ru/"
                                       target="_blank"><img class="lazyOwl"
                                                            src="{{asset('img/kosmetologiya-preview.jpg')}}"></a>
                                    <p>Косметоллгия Казань</p>
                                </div>
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-15', '', 'full-size');"><img
                                                class="lazyOwl"
                                                src="{{asset('img/pishiprosto-preview.jpg')}}"></a>
                            ...
                            <div class="slider">
                                <div class="slider-item">
                                    <a href="https://valery.fm/morozov_million" target="_blank">
                                        <img class="lazyOwl" src="{{asset('img/morozov-preview.jpg')}}">
                                    </a>
                                    <p>Курс “Продюсер-миллионер”</p>
                                </div>
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-17', '', 'full-size');">
                                        <img class="lazyOwl"
                                                src="{{asset('img/sprint-preview.jpg')}}"></a>
                                    <p>Контент-спринт от Пиши Просто</p>
                                    <div class="content-to-populate-in-modal" id="modal-content-17">
                                        <img data-img-src="{{asset('img/sprint.jpg')}}" class="lazy full-width"
                                             alt="pishiprosto">
                                    </div>
                                </div>
                            </div>
                ...
                <section class="feature-columns row clearfix">
                    ...
                    <article class="feature-col col-md-4">
                        ...
                        <div class="content-to-populate-in-modal" id="modal-content-18">
                            ...
                            <div class="slider">
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-19', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/delmar1-preview.jpg')}}">
                                    </a>
                                ...
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-20', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/delmar2-preview.jpg')}}">
                                    </a>
                                ...
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-21', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/delmar3-preview.jpg')}}">
                                    </a>
                            ...
                            <div class="slider">
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-22', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/rotach1-preview.jpg')}}">
                                    </a>
                                ...
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-23', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/rotach2-preview.jpg')}}">
                                    </a>
                                ...
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-24', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/rotach3-preview.jpg')}}">
                                    </a>
                    ...
                    <!-- feature 5 -->
                    <article class="feature-col col-md-4">
                        <a href="" onclick="populate_and_open_modal(event, 'modal-content-30', '', 'full-size');"
                           class="thumbnail linked">
                            <div class="image-container">
                        ...
                        <div class="content-to-populate-in-modal" id="modal-content-30">
                            <div class="slider">
                                <div class="slider-item">
                                    <a href="{{asset('img/Kom_pred.pdf')}}" target="_blank">
                                        <img class="lazyOwl" src="{{asset('img/kostenko-preview.jpg')}}">
                                    </a>
                            ...
                            <div class="slider">
                                ...
                                <div class="slider-item">
                                    <a href="https://valery.fm/antichaos2" target="_blank">
                                        <img class="lazyOwl" src="{{asset('img/morozovoto-preview.jpg')}}">
                                    </a>
                                    <p>Лид-магнит</p>
                                </div>
                            </div>
                        ...
                        <div class="content-to-populate-in-modal" id="modal-content-28">
                            <div class="slider">
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-17', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/sprint-preview.jpg')}}">
                                    </a>
                                    <p>Лендинг</p>
                                </div>
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-15', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/pishiprosto-preview.jpg')}}">
                                    </a>
                                    <p>Лид-магнит</p>
                                </div>
                                <div class="slider-item no-link">
                                    <a href=""
                                       onclick="populate_and_open_modal(event, 'modal-content-29', '', 'full-size');">
                                        <img class="lazyOwl" src="{{asset('img/sprintlessons-preview.jpg')}}">
                                    </a>
                                    <p>Страницы уроков</p>
                                    <div class="content-to-populate-in-modal" id="modal-content-29">
                                        <img data-img-src="{{asset('img/sprintlessons.jpg')}}"
