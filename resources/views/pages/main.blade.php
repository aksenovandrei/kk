        ...
        <div class="content-wrapper clearfix">
            ...
            <div id="features-carousel" class="carousel slide with-title-indicators max-height"
                ...
                <ol class="carousel-indicators title-indicators">
                    ...
                    <li data-target="#features-carousel" data-slide-to="2">Роман Шляхов</li>
                </ol>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <div class="carousel-text-content">
                            <p class="reply-text">"Алина, привет)
                                ...
                                Запуск пошел - спешу поблагодарить тебя и твою “Контент Квартиру” за качественную
                                работу) Ребята, вы супер!

                                Сначала признаюсь, конечно, скептически относился к тому, что писать письма будет Юля, а
                                не ты. Не знал ее уровня. В принципе, после первого письма все эти сомнения отпали)
                                ...
                                Не раз обращался с просьбой подправить, дописать текст… Всегда только положительный
                                ответ, оперативная помощь и мега лояльность.

                                Без преувеличения - получил больше, чем ожидал. Очень рад, что вас нашел.
                                Получился качественный контент, заточенный под мою стилистику и манеру подачи. Дух
                                программы почувствовали, как надо)
                    ...
                    <div class="item">
                        <div class="carousel-text-content">
                            <p class="reply-text">"Александра, один из основных активов каждого успешного бизнеса - это
                                команда. Команда профессионалов, которые любят свое дело. И я очень благодарна вам, что
                                вы стали для меня такой командой. Мне очень приятно сотрудничать с вами, мне нравится
                                ваша проактивность, креативность и исполнительность. Что ещё нужно для того, чтобы
                                сосредоточится на важных стратегических вещах, зная что у меня тылы прикрыты надежными
                                партнерами?:) Без сомнений, сотрудничество с вами было одним из моих удачнейших решений.<br><br>

                                И ещё вы меня поддерживаете очень сильно, я чувствую что вы в меня верите и для меня это
                                важно. Я уверена, что люди не зря встречаются в жизни. И мне очень приятно общаться с
                                вами, сотрудничать и делиться мыслями. Потому что я чувствую в вас отклик. Алина
                                молодец, что собрала у себя таких людей. Ей особенный респект."
                            </p>
                    ...
                    <div class="item">
                        <div class="carousel-text-content">
                            <p class="reply-text">"Хочу выразить огромную благодарность команде “Контент Квартира” за их
                                высокий профессионализм и качество исполнения работы.
                                Почему я выбираю именно их:
                                1. Они всегда точно понимают мою ЦА, что они хотят, но самое главное, что я хочу им
                                донести.
                                2. Всегда выполняют в срок.
                                3. Мне не приходится самому дополнительно корректировать текст, только делаю иногда 1%
                                корректировки, и то в силу того, что я работаю в мягкой нише, и там есть свой сленг и
