        ...
        <div class="content-wrapper clearfix wow fadeInDown" data-wow-delay="0.3s">
            <div class="col-sm-10 col-md-9 pull-right">
                ...
                <section class="feature-text">
                    <h1><span>[</span>Контент<span>]</span> Квартира</h1>
                    <p>Ваш удаленный контент-отдел</p>
                    <h4>Решим задачу качественного присутствия Вашего хуя в сети</h4>
    ...
    <article id="carousel" class="section-wrapper clearfix" data-custom-background-img="{{asset('img/bg6.jpg')}}">
        <div class="content-wrapper clearfix">
            ...
            <div id="features-carousel" class="carousel slide with-title-indicators max-height"
                ...
                <h2 class="section-title" style="margin-top: 10%">Отзывы</h2>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <div class="carousel-text-content">
                            <img src="{{asset('img/Obuhovskiy.jpg')}}" class="icon" alt="Lorem Ipsum">
                    ...
                    <div class="item">
                        <div class="carousel-text-content">
                            <img src="{{asset('img/Granyts1.png')}}" class="icon" alt="Lorem Ipsum">
                            <img src="{{asset('img/Granyts2.png')}}" class="icon" alt="Lorem Ipsum">
                    ...
                    <div class="item">
                        <div class="carousel-text-content">
                            <img src="{{asset('img/Gavrilova1.png')}}" class="icon" alt="Lorem Ipsum">
                            <img src="{{asset('img/Gavrilova2.jpg')}}" class="icon" alt="Lorem Ipsum">
                            <h2 class="title">Ирина Гаврилова</h2>
                            <p>Бизнес-тренер уровня PCC ICF</p>
                            <p>Работали с проектом в качестве удаленного контент-отдела: взяли на себя все задачи от
                                разработки стратегии до регулярного постинга в соцсетях и в блоге.</p>
                            <p><a href="#" class="btn btn-outline-inverse btn-sm">Все отзывы</a></p>
    ...
    <article id="tabs" class="section-wrapper clearfix" data-custom-background-img="{{asset('img/bg2.jpg')}}">
        <div class="content-wrapper mid-vertical-positioning clearfix">
            <div class="col-sm-10 col-md-9 pull-right">
                ...
                <h1 class="section-title" style="margin-top: 20%">Наши услуги</h1>
